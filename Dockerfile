...
RUN wget http://apache.rediris.es/spark/spark-2.3.2/spark-2.3.2-bin-hadoop2.7.tgz  && \
...
RUN cp /postgresql-42.2.2.jar /apache-hive-2.3.4-bin/lib
RUN cp /postgresql-42.2.2.jar /spark-2.3.2-bin-hadoop2.7/jars
...
COPY files/hive-site.xml /apache-hive-2.3.4-bin/conf
COPY files/hive-site.xml /spark-2.3.2-bin-hadoop2.7/conf
